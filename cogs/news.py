...
class News(commands.Cog):
    ...
    def source(self, key):
        ...
        embed = discord.Embed(
            title=source["name"], description=news["title"], color=0xFF5733
        )
        embed.set_author(
            name="FootBot News",
    ...
    async def news(self, ctx, option: Optional[str]):
        ...
        if option == "list":
            ...
            embed = discord.Embed(
                title="List of Sources", description=sourcenames, color=0xFF5733
            )
            embed.set_author(
                name="FootBot",
                url="https://www.youtube.com/watch?v=dQw4w9WgXcQ",
            ...
            embed.set_thumbnail(
                url="https://i.pinimg.com/originals/8f/23/bd/8f23bd594b6ad1be9fbe03a67c892f67.png"
            )
